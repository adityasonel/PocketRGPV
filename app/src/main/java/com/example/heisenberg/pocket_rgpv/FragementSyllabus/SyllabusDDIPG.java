 ...
 */
public class SyllabusDDIPG extends Fragment {

    private int lastExpandedPosition = -1;

    public SyllabusDDIPG() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        //return inflater.inflate(R.layout.fragment_syllabus_ddipg, container, false);
        ...
        expandableListView.setAdapter(new SyllabusDDIPG.SyllabusExpandableListAdapter());
