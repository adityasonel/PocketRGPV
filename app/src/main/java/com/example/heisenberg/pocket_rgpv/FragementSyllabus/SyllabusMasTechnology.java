 ...
 */
public class SyllabusMasTechnology extends Fragment {

    private int lastExpandedPosition = -1;

    public SyllabusMasTechnology() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
       ...
       // return inflater.inflate(R.layout.fragment_syllabus_mas_technology, container, false);
        ...
        expandableListView.setAdapter(new SyllabusMasTechnology.SyllabusExpandableListAdapter());
