 ...
 */
public class SchemeMasCompApplication extends Fragment {

    private int lastExpandedPosition = -1;

    public SchemeMasCompApplication() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
       ...
       // return inflater.inflate(R.layout.fragment_scheme_mas_comp_application, container, false);
        ...
        expandableListView.setAdapter(new SchemeMasCompApplication.SchemeExpandableListAdapter());
    ...
    public class SchemeExpandableListAdapter extends BaseExpandableListAdapter {
        ...
        private String[][] branches = {
                {"MASTER OF COMPUTER APPLICATIONS (Grading Sys.)"},
                {"MASTER OF COMPUTER APPLICATIONS (Grading Sys.)"},
                {"M.C.A.(Grading Sys)"},
                {"Scheme for M.C.A. 4th sem(Grading Sys)"},
                {"MCA (Non Grading)", "MCA (Grading)"},
                {"MCA (Grading)"}
        };
