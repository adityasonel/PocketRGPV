 ...
 */
public class SchemeDDIPG extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
       ...
       // return inflater.inflate(R.layout.fragment_scheme_ddipg, container, false);
        ...
        expandableListView.setAdapter(new SchemeDDIPG.SchemeExpandableListAdapter());
