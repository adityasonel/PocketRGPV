 ...
 */
public class SyllabusMCADualDegree extends Fragment {

    private int lastExpandedPosition = -1;

    public SyllabusMCADualDegree() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        //return inflater.inflate(R.layout.fragment_syllabus_mcadual_degree, container, false);
        ...
        expandableListView.setAdapter(new SyllabusMCADualDegree.SyllabusExpandableListAdapter());
