 ...
 */
public class SyllabusMAMDualDegree extends Fragment {

    private int lastExpandedPosition = -1;

    public SyllabusMAMDualDegree() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        //return inflater.inflate(R.layout.fragment_syllabus_mamdual_degree, container, false);
        ...
        expandableListView.setAdapter(new SyllabusMAMDualDegree.SyllabusExpandableListAdapter());
