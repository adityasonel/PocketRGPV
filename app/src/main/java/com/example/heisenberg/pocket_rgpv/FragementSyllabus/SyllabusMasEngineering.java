 ...
 */
public class SyllabusMasEngineering extends Fragment {

    private int lastExpandedPosition = -1;

    public SyllabusMasEngineering() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
       ...
       // return inflater.inflate(R.layout.fragment_syllabus_mas_engineering, container, false);
        ...
        expandableListView.setAdapter(new SyllabusMasEngineering.SyllabusExpandableListAdapter());
