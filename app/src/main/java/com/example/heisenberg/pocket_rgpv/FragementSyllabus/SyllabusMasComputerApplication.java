 ...
 */
public class SyllabusMasComputerApplication extends Fragment {

    private int lastExpandedPosition = -1;

    public SyllabusMasComputerApplication() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        //return inflater.inflate(R.layout.fragment_syllabus_mas_computer_application, container, false);
        View view = inflater.inflate(R.layout.fragment_syllabus, null);
        final ExpandableListView expandableListView = (ExpandableListView) view.findViewById(R.id.expandableListViewSyllabus);
        expandableListView.setAdapter(new SyllabusMasComputerApplication.SyllabusExpandableListAdapter());
    ...
    public class SyllabusExpandableListAdapter extends BaseExpandableListAdapter {
        ...
        private String[] semester = {"1st Semester", "2nd Semester", "3rd Semester", "4th Semester", "5th Semester"};
