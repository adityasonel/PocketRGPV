 ...
 */
public class SyllabusBachPharma extends Fragment {

    private int lastExpandedPosition = -1;

    public SyllabusBachPharma() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
       ...
       // return inflater.inflate(R.layout.fragment_syllabus_bach_pharma, container, false);
        ...
        expandableListView.setAdapter(new SyllabusBachPharma.SyllabusExpandableListAdapter());
