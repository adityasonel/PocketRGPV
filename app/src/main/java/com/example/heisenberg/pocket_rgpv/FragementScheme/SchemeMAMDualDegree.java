 ...
 */
public class SchemeMAMDualDegree extends Fragment {

    private int lastExpandedPosition = -1;

    public SchemeMAMDualDegree() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
       ...
       // return inflater.inflate(R.layout.fragment_scheme_mamdual_degree, container, false);
        ...
        expandableListView.setAdapter(new SchemeMAMDualDegree.SchemeExpandableListAdapter());
