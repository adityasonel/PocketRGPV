 ...
 */
public class SchemeMasTechnology extends Fragment {

    private int lastExpandedPosition = -1;

    public SchemeMasTechnology() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
       ...
       // return inflater.inflate(R.layout.fragment_scheme_mas_technology, container, false);
        ...
        expandableListView.setAdapter(new SchemeMasTechnology.SchemeExpandableListAdapter());
