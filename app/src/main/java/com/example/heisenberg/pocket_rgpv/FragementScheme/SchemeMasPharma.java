 ...
 */
public class SchemeMasPharma extends Fragment {

    private int lastExpandedPosition = -1;

    public SchemeMasPharma() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        //return inflater.inflate(R.layout.fragment_scheme_mas_pharma, container, false);
        ...
        expandableListView.setAdapter(new SchemeMasPharma.SchemeExpandableListAdapter());
