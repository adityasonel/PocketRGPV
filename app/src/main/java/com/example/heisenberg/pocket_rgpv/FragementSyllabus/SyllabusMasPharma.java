 ...
 */
public class SyllabusMasPharma extends Fragment {

    private int lastExpandedPosition = -1;

    public SyllabusMasPharma() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
       ...
       // return inflater.inflate(R.layout.fragment_syllabus_mas_pharma, container, false);
        ...
        expandableListView.setAdapter(new SyllabusMasPharma.SyllabusExpandableListAdapter());
