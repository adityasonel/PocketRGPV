 ...
 */
public class SyllabusBachEngineering extends Fragment {

    private Context context;

    public SyllabusBachEngineering() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        expandableListView.setAdapter(new SyllabusExpandableListAdapter());
        return view;
    }
    ...
    public class SyllabusExpandableListAdapter extends BaseExpandableListAdapter {
        ...
        public View getGroupView(int groupPosition, boolean isExpanded, View convertView, ViewGroup parent) {
            ...
            return convertView;
              ...
              //TextView textView = new TextView(SyllabusBachEngineering.this.getActivity());
