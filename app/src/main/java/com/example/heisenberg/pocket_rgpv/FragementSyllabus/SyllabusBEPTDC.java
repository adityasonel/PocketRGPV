 ...
 */
public class SyllabusBEPTDC extends Fragment {

    private int lastExpandedPosition = -1;

    public SyllabusBEPTDC() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
       ...
       // return inflater.inflate(R.layout.fragment_syllabus_beptdc, container, false);
        ...
        expandableListView.setAdapter(new SyllabusBEPTDC.SyllabusExpandableListAdapter());
