 ...
 */
public class SchemeBachEnginnering extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
       ...
       // return inflater.inflate(R.layout.fragment_scheme, container, false);
        ...
        expandableListView = (ExpandableListView) view.findViewById(R.id.expandableListViewScheme);
        expandableListView.setAdapter(new SchemeBachEnginnering.SchemeExpandableListAdapter());
    ...
    public class SchemeExpandableListAdapter extends BaseExpandableListAdapter {
        ...
        private String[][] branches = {
                {"B.E. A/B Group (common to all branch)", "B.Pharma. A/B Group (common to all branch)"},
                {"Computer Science & Engineering (G.S.)", "Mechanical Engineering (G.S.)", "Civil Engineering (G.S.)", "Information & Technology (G.S.)",
                    "Electronic & Communication (G.S.)", "Fire Tech & Safety (G.S.)"},
                {"Computer Science & Engineering (G.S.)", "Mechanical Engineering (G.S.)", "Civil Engineering (G.S.)", "Information & Technology (G.S.)",
                        "Electronic & Communication (G.S.)", "Fire Tech & Safety (G.S.)"},
                {"Computer Science & Engineering (G.S.)", "Mechanical Engineering (G.S.)", "Civil Engineering (G.S.)", "Information & Technology (G.S.)",
                        "Electronic & Communication (G.S.)", "Fire Tech & Safety (G.S.)"},
