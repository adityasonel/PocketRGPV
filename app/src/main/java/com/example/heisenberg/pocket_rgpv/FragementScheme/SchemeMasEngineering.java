 ...
 */
public class SchemeMasEngineering extends Fragment {

    private int lastExpandedPosition = -1;

    public SchemeMasEngineering() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
       ...
       // return inflater.inflate(R.layout.fragment_scheme_mas_engineering, container, false);
        ...
        expandableListView.setAdapter(new SchemeMasEngineering.SchemeExpandableListAdapter());

        expandableListView.setOnGroupExpandListener(new ExpandableListView.OnGroupExpandListener() {
            @Override
            public void onGroupExpand(int groupPosition) {
                if(groupPosition != -1 && groupPosition != lastExpandedPosition){
    ...
    public class SchemeExpandableListAdapter extends BaseExpandableListAdapter {
        ...
        private String[] semester = {"1st Semester", "2nd Semester", "3rd Semester", "4th Semester"};

        private String[][] branches = {
                {"Adv. Prod. Sys, CIM (Grading Sys)", "Heat Power, H.P and Thermal, T S Dgn(Grading Sys)", "Industrial Engg. Management (Grading Sys.)", "Machine Dgn and Robotics(Grading Sys)"},
                {"Adv. Prod. Sys., CIM (Grading Sys)", "HeatPower, H.P and Thermal, T S DGN (Grading Sys)", "Industrial Engg. Management (Grading Sys)", "Information & Technology"},
